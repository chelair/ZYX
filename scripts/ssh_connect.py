...
选项:
  ...
  --key KEY_PATH        私钥路径（默认 SSH_KEY_DEFAULT）
...
import os
import sys
from config import SSH_KEY_DEFAULT, SSH_KEY_ED25519
...
def parse_args():
    ...
    parser.add_argument("--key", default=str(SSH_KEY_DEFAULT), help="私钥路径")
